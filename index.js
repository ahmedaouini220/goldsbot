...
client.on("messageCreate", (yahya) => {
  if (yahya.content.startsWith(prefix + `fb`)) {
    ...
    yahya.delete()
    yahya.channel.send(`**
> <a:983154473667035207:1038428647197003839>・برجاء عمل فيد باك للاداري ${user} <a:2_:1038428627135627344> 
  ...
  if(interaction.isSelectMenu()) {
      if(interaction.customId === 'Info') {
          if(interaction.values[0] === '1') {
              ...
              interaction.reply({ content: '> <#1036284848014372965> : دي روم التقديم على البائعين\n > <#1036284848014372965> : دي روم التقديم على الوسطاء', ephemeral: true })   
          }
      }
  }
})
